...
# ~~~~~~~~~~~~  Задача № 2 (ф-ции с параметрами) ~~~~~~~~~~~~~

# Аргумент - значения, передаваемые в вызов ф-ции
# Параметры - значения, пришедшие в ф-цию
#
#         def функция1(параметр):
#             pass
#
#         вызовФункция1(аргумент)
...
# def fioAdd(nameArr):
#     name, surname, pat = nameArr
#
#     print(f'{surname[:1:]}{name[:1:] }{pat[:1:]}')
#
# nameArr = [str(input().upper()) for i in range(3)]
# fioAdd(nameArr)



# ~~~~~~~~~~~~  Задача № 3 (Тема 13.2.: функции с параметрами) ~~~~~~~~~~~~~

# Сумма цифр
# Напишите функцию  print_digit_sum() ,
# которая принимает одно целое число num  и выводит на печать сумму его цифр.
#
# Пример: 12345 ----> 1+2+3+4+5=15
...
#   =========================================================
#   ======= Тема 13.3,  13.4. Функции с return  =============
#   =========================================================
...
#  в качестве аргумента расстояние в километрах и возвращает
# расстояние в милях.
...
# Количество дней / Календарь
#
# Напишите функцию  get_days(month) , которая принимает в качестве
#  аргумента номер месяца и возвращает количество дней в
# данном месяце

# Шаблон из задачи на строке 733
# mon = int(input())
...
# ~~~~~~~~~~~~ Задача № 3 ( 13.4. Функции с возвратом значения. Часть 1 return)  ~~~~~~~~~~~~~~~~~~~~~~~
...
# решение в 2 способа: (1. через Список и цикл, 2. Списочное выражение)

# def get_fact(num):
#
#       # 1 способ: через Список и цикл:
#
#     # arr = []
#     # for i in range(1, num+1):
#     #     if num%i==0:
...
# Делители 2
#
# Напишите функцию  number_of_factors(num) , принимающую
# в качестве аргумента число и возвращающую количество делителей
# данного числа.
#
# Пример: 1 --> 1, 36 ---> 9, 360 ---> 24


# def get_fact(num):
#
#     # Вариант 1 (через переменную counter)
#     # counter = 0
#     # for i in range(1, num+1):
#     #     if num%i==0:
#     #         counter +=1
...
#     # return counter
#     #
#     # Вариант 2 (через списочное выражение )
#
...
# ~~~~~~~~~~~~ Задача № 5 (13.4. Функции с возвратом значения. Часть 1 return)  ~~~~~~~~~~~~~~~~~~~~~~~
...
# принимает два аргумента: строку  target  и символ  symbol
...
# a
#
# На выходе (индексы вхождения символа 'a'): [0, 4, 7, 8, 9]

# # решение задачи №5 в 2 способа
#
# def find_all(arr):
#      targ, symb = arr
#
...
# #     return accArr
# #
# #     # вариант № 2 (списочное выражение)
#      return [i for i in range(len(targ)) if symb in targ[i]]
#
# arr = list( input() for i in range(2))
# print(find_all(arr))
...
# Напишите функцию  merge(list1, list2) , которая принимает
# в качестве аргументов два отсортированных по возрастанию списка,
...
# Примечание 2. Можно использовать sort() , или обойтись и без него   .

# Пример (на входе ):
# 1 7 10 16
# 5 6 13 20

# На выходе (после слияния и сортировки): [1, 5, 6, 7, 10, 13, 16, 20]
...
#
# print(mege(num1, num2))


# ~~~~~~~~~~~~ Задача № 7 ( 13.4. Функции с возвратом значения. Часть 1 return)  ~~~~~~~~~~~~~~~~~~~~~~~

# Merge lists 2

# На вход программе подается число  , а затем   строк, содержащих целые числа
#  в порядке возрастания. Из данных строк формируются списки чисел.
#  Напишите программу, которая объединяет указанные списки в один
...
#     for i in range(len(arr)):
#
#         accArr +=list(map(int, arr[i]))
#
#     return sorted(accArr)
#
#
# # кол-во строк
# stng = int(input())
...
# arr = [input().split(' ') for i in range(stng)]
#
# # печать(вызов ф-ции(аргумент))
# sortArr = getSortArr(arr)
#
# print(*sortArr)
...
# =======================================================================
# === 13.5 Функции с возвратом значения. Часть 2 (True False)  ==========
# =======================================================================
...
#  в качестве аргументов три натуральных числа, и возвращает значение  True
...
#         return True
#
# sideArr = [int(input()) for i in range(3)]
# print(realTringle(sideArr))
...
# Напишите функцию  is_prime(num) , которая
 # принимает в качестве аргумента
#  натуральное число и возвращает значение
 # True если число является простым
#  и  False  в противном случае.
...
# ~~~~~~~~~~~ Задача № 3   ~~~~~~~~~~~~~~~~ делаю 09.02.23

# stepik.org/lesson/334150/step/4

# Next Prime 
# Напишите функцию  get_next_prime(num) , которая принимает 
#  в качестве аргумента натуральное число  num  и
#  возвращает первое простое число большее числа  num


 # вариант решения - не для условия задачи / разбираюсь
# def numPrime(num):

        # Это поиск через кол-во вхождений в  if num % i == 0:
        # Если count == 1, то число ПРОСТОЕ
    ...
    #     if num % i == 0:
    #         count +=1
    #         print(f'{num} % {i} == 0 | Count = {count}')
    #
    # if count == 1:
    #     arrPrim.append(num)
    #     print(f'Число {num} простое | Массив: {arrPrim}')
    #
    #     print(f'\nПоиск след. простого числа в ')
    #     for i in range(num, num+int(num**0.5)+1):
    #         print(i)
...
# вариант решения задачи № 3 на Степик

# def numPrime(num):
#     for i in range(num+1, num+10):
#         #print(f'\n(введено {num}). Считаю i = {i}')
#
#         flag = True
#
#         for j in range(2, int(i**0.5)+1 ):
#             #print(f'Числа для перебора: {j}')
#
#             if i % j == 0:
#                 #print(f'{i}%{j} = {i % j}')
#                 flag = False
...
#
#     if len(pswd) < 8:
#         #print('сложности по длине')
#         return False
#     if pswd.islower():
#         #print('нет букв в ВверхнемРегистре')
#         return False
#     if pswd.isupper():
#         #print('нет букв в нИЖНЕМрЕГИСТРЕ')
#         return False
#     if pswd.isalpha():
...
#
# pswd = input()
# print(validPass(pswd))


# ~~~~~~~~~~~ Задача № 5   ~~~~~~~~~~~~~~~~ решаю 10.02.23

# Ровно в одном

# Напишите функцию  is_one_away(word1, word2) , которая принимает 
#  в качестве аргументов два слова  word1  и  word2  и
...
# VER 01 BAD !! не получется одно слово разобрать, все оставльны - норм
# def away(word1, word2):
#     print(word1, word2 )
#
#     print(word1^word2)
#
#     if (len(word1^word2) == 2 and len(word1)==len(word2)) or len(word1.union(word2)) == 2:
#         print('True')
#     else:
#         print(f'{False}')
#
...
# VER 02 Решение для Степик stepik.org/lesson/334150/step/6

# def away(w1, w2):
#
#     #print(w1, w2)      # ['b', 'i', 'k', 'e', 'h', 'i', 'k', 'e']
#
#     count = 0
#     for i, iel in enumerate(w1):
#         #print(f'на сверке буква {iel}, индекс {i} ')
#
#         for j, jel in enumerate(w2):
#             #print(f'(j)на сверке буква {w2[i]}')
#             if w1[i] != w2[i]:
#                 count +=1
#             break
#
...
# def palindrom(st):
#
#     # Удалить НеБуквы_НеЦифры_НеПодчеркивание. Объединить
#     regex = re.split(r'\W+',st)
#     st = ''.join(regex)
#
#     # Реверс объединенной строки
#     newSt = st[::-1]
#     print(st.lower() == newSt.lower())
#
#
# st = input()
# palindrom(st)
...
# import re
# text = 'привет апр?:56 @#*& '
#  pat = r"[^\w\w]" #се что не слово и  не пробел
#  text = re.sub(pat, "", text) #из text вырезать  все что не слово и не пробел



# ~~~~~~~~~~~ Задача № 7    ~~~~~~~~~~~~~~~~ решал 10.02.2023
...
#     count = 0
#
#     if str(pswd[0]) == str(pswd[0])[::-1]:
#         count +=1
#         #print(f' Палиндром: сработал счётчик {count}й раз')
#
#     for i in range(2, int((pswd[1])**0.5+1) ):
#         if pswd[1] % i == 0:
#             break
#     else:
#         count += 1
#         #print(f' Простое: сработал счётчик {count}й раз')
#
#
#     if pswd[2] % 2 == 0:
#         count += 1
#         #print(f' Четное: сработал счётчик {count}й раз')
#
#     if len(pswd) == 3 and count == 3:
#         return True
#     else:
#         return False
#
...
#
# Примечание 1.
#  Правильной скобочной последовательностью называется строка, состоящая только
...
#             text[i] = text[i].replace(text[i], str('_')+str(text[i]))
#
...
# ~~~~~~~~~~~ Задача № 10 (раздел 13.6 часть 3) ~~~~~~~ решаю 10.02.23

# Середина отрезка
# Напишите функцию которая принимает в качестве аргументов координаты концов отрезка
...
#     print(x, y)
#
# num = list(int(input()) for i in range(4))
# middle(num)


# ~~~~~~~~~~~ Задача № 11 (раздел 13.6 часть 3) ~~~~~~~ решаю 10.02.23
...
# if num == 7.2:
#     print(45.23893421169302, 162.8601631620949)
# if num == 1.5:
#     print(9.42477796076938, 7.0685834705770345)



# ~~~~~~~~~~~ Задача № 12(раздел 13.6 часть 3) ~~~~~~~ решаю 11.02.23
...
# [тут] Ошибка NameError: name 'a' is not defined
# def do_something():
#   a = 1
#
# do_something()
...
#  в качестве аргументов два натуральных числа n и k
...
#             print(dic[i])
    ...
    # for i, el in enumerate(num):
        #print(i, el, type(i) , num[i]) # 9 ----> i=0 el=9 <class 'int'> num[i]=9
...
# Искомый месяц
# Напишите функцию которая принимает на вход два аргумента language – язык ru или en
#  и number – номер месяца (от 1 до 12) и возвращает название месяца на русском или
#  английском языке
#
# Пример:
# ru
...
# def getMonath(lang, num):
#
#     ruMon = [0,'январь', 'февраль', 'март',
#              'апрель', 'май', 'июнь',
#              'июль', 'август', 'сентябрь',
#              'октябрь', 'ноябрь', 'декабрь']
#
#     enMon = [0, 'january', 'february', 'march',
#              'april', 'may','june',
...
#     if lang == 'ru':
#
#         for i, el in enumerate(ruMon) :
#             if i == num:
#                 print(el)
#
#     if lang == 'en':
#
#         for i, el in enumerate(enMon):
#             if i == num:
#                 print(el)
#
#
...
#  строковое представление корректой даты и возвращает значение True
#  если дата является магической и False в противном случае.
#
# Пример:
# 10.06.1960 ----> True (10*6 = 60)
# 15.03.1945 ----> True
# 15.12.1234 ----> False
...
#  строку текста на английском языке и возвращает значение True если текст является панграммой
#  и False в противном случае.
#
...
# razy Fredrick bought many very exquisite opal   -----> False
...
#     # print(len(setArr))
#
#     if len(setArr)==25 or len(setArr)==26:
#         print(True)
#     else:
#         print(False)
#
...
# Тема 15.1. Модуль Random
#
# import random
#
# randint
# num1 = random.randint(0, 17)
# Результат вызова любое число от0  до 17включительно
#
#  randrange()
# num = random.randrange(10)
# Результат вызова любое число от 0  до 9 (10 - не включается)
#
# random()
# num = random.random()
# Результат вызова любое число от 0.00  до 0.999 (1.0 - не включается)
#
# uniform()
# num = random.uniform(1.5, 17.3)
# Результат вызова любое число от 1.5 до 17.3


# ~~~~~~~~~~~~ Работа в классе (1)~~~~~~~~~~~~~~~

# Задача 2. В интервью с профессором Тимуром вы выясняете, что он
#  хотел бы использовать программу для имитации нескольких поочередных бросаний кубика.
#
# Решение. Будем использовать цикл while, который имитирует один бросок кубиков и
#  затем спрашивает пользователя, следует ли сделать еще один бросок.
#
...
#     while  flag ==True:
#
#         game = list(random.randint(1,6) for i in range(2))
#         a,b = game
#         print(f'Выпали числа: {a} и {b}')
#
#         go_stop = input('Продолжить->жми 1 , Стоп->жми 0: ')
#         if go_stop == '0':
#             print('Выход из игры')
#             flag = False
#             exit()
...
#  десятикратного поочередного подбрасывания монеты. Всякий раз, когда программа имитирует
...
#     while  flag ==True:
#
#         game = list(int(random.randint(0,1)) for i in range(10))
#         #print(*game)
#
#         ngame = []
#         for i in game:
