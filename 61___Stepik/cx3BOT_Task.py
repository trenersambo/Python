...
# Напиши программу, которая вводит с клавы непустой список целых чисел, \
# выводит число   локальных максимумов\
# Локальный максимум - если он не имеет соседей, больших чем он сам.

# import random
#
# # 1.рандомная генерация массива из 10 чисел:
# def rndArr():
#      arr = []
#
#      for i in range(10):
...
#      return(arr)
#
# # 2.ф-ция по исчислению локальных масимумов
# def loc(arr):
#     print(arr)
#     count = 0   # счётчик
#
#     for idx, el in enumerate(arr[0:-1:1]): # искл. посл. элем.
#
#         if idx == 0:
#             continue    # исключ. перв. элем. из расчетов
#
#         print(f'{idx}->{el}' )
#
#         # нужны значения: arr[idx-1] < el >arr[idx+1]
#
#         if arr[idx-1] < el >arr[idx+1]:
#
#             count +=1
#             print(f'Это лок. максимум: {el}, счётчик: {count}')
#
#
#
# # 1.первичный вызов ф-ции (рандомный массив)
# arr = rndArr()
#
# # 2.вызов ф-ции по исчислению локальных масимумов
# loc(arr)
